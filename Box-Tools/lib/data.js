...
var knowledge_base = {
  ...
  [
    ...
    ['goto', '无条件跳转语句'],
    ['switch', '用于开关语句（与 case 连用）'],
    ['case', '开关语句分支（与 switch 连用）'],
    ['default', '开关语句中的“其他”分支'],
    ['return', '子程序返回语句（可以带参数，也可以不带参数,要看返回值类型）'],
    ['auto', '声明自动变量 一般不使用'],
    ...
    ['sizeof', '计算数据类型或变量的长度'],
    ['typedef', '用以给数据类型取别名'],
    ['volatile', '易变型变量，说明变量在程序执行中可被隐含地改变']
  ],
  'ESC':
  [
    ["转义字符\\' ", "单引号'（Single Quote）"],
    ['转义字符\\" ', '双引号"'],
    ["转义字符\\? ", "问号?（Question Mark）"],
    ["转义字符\\\\ ", "反斜线\（Backslash）"],
    ["转义字符\\a ", "响铃（Alert，或Bell）"],
    ["转义字符\\b ", "退格（Backspace）"],
    ["转义字符\\f ", "分页符（Form Feed）"],
    ["转义字符\\n ", "换行（Line Feed）"],
    ["转义字符\\r ", "回车（Carriage Return）"],
    ["转义字符\\t ", "水平制表符（Horizontal Tab）"],
    ["转义字符\\v ", "垂直制表符（Vertical Tab）"],
...
export { ASCIIshow, knowledge_base }